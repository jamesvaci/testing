...
foreach ($categories as $value) {
  ...
  echo "<div class='col-sm-6 col-sm-4 col-md-4'><div class='imageBox'><img class='categoryTumb' src='./img/category/".$img.".png'/><a href='index.php?url=pages/viewproduct/aquahome_equipment_for_bathrooms/".$img."'>".$name."</a></div></div>";
}
echo "</div>";
?>
