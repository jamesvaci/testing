...
$(document).ready(function(){
  ...
  $('.dropdownMainCategory').on('click', function(){
    $('#dropdownMainCategory')[0].previousElementSibling.value = this.text;
    $('#dropdownMainCategory').html(this.text);
  });
  $('.dropdownMainCategoryAdd').on('click', function(){
    $('#dropdownMainCategoryAdd')[0].previousElementSibling.value = this.text;
    $('#dropdownMainCategoryAdd').html(this.text);
  });
  $('.dropdownSubCategory').on('click', function(){
    $('#dropdownSubCategory')[0].previousElementSibling.value = this.text;
    $('#dropdownSubCategory').html(this.text);
  });
})
